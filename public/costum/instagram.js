                    ...
                    (t.initWidget = function (n, i) {
                        if (o) {
                            ...
                            var a = {
                                    ...
                                    // deactivate:
                                    //     1 === i.preferences.disable_widget,
                                    // deactivatedWidgetUrl:
                                    //     i.preferences.deactivated_widget_url,
                                    // showElfsightLogo:
                                    //     !i.preferences.hide_elfsight_logo,
                                    // owner: i.isOwner,
                                    // platform: i.platform,
                                    // freeLinkUrl: i.preferences.free_link_url,
                                    // displayFreeLink:
                                    //     !!i.preferences.display_free_link,
                                    // displayFreeLinkRemove:
                                    //     !!i.preferences
                                    //         .display_free_link_remove,
                                    // freeLinkURL: i.preferences.free_link_url,
                                    // freeLinkRemoveURL:
                                    //     i.preferences.free_link_remove_url,
                                    // freeLinkAnchor:
                                    //     i.preferences.free_link_anchor,
                                    // displayDeactivation:
                                    //     !!i.preferences.display_deactivation,
                                    // deactivationURL:
                                    //     i.preferences.deactivation_url,
                                },
