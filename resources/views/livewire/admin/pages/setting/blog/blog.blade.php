<div>
    <x-slot name="header">
        <livewire:admin.global.page-header judul="Blog" subjudul="Blog" :breadcrumb="['Blog']" />
    </x-slot>
    ...
    <div class="card">
        ...
        <div class="card-body">
            @if (!$isAdd)
                <div class="text-left">
                    <button type="button" class="btn btn-primary" wire:click="add">Create Blog <i
                            class="icon-paperplane ml-2"></i></button>
                </div>
                <hr />
                <livewire:admin.pages.setting.blog.blog-table />
            @else
                <form action="#" wire:submit.prevent="save">
                    <fieldset class="mb-3">
                        <legend class="text-uppercase font-size-sm font-weight-bold">Add Blog</legend>
