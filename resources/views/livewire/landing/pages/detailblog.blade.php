     ...
     <div class="container">
         <div class="row">
             <div class="col-sm-12 blog-detail">
                 <img src="../assets/images/about/about-us.jpg" class="img-fluid blur-up lazyload" alt="">
         ...
         <div class="row section-b-space blog-advance">
             <div class="col-lg-6">
                 <div><img src="../assets/images/blog/1.jpg" class="img-fluid blur-up lazyload bg-img" alt="">
                 </div>
             </div>
             <div class="col-lg-6">
                 <div><img src="../assets/images/blog/2.jpg" class="img-fluid blur-up lazyload bg-img" alt="">
                 </div>
             </div>
             <div class="col-lg-6">
                 <ul>
